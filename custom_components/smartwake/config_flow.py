...
class SmartWAKEOptionsFlow(config_entries.OptionsFlow):
    ...
    async def async_step_musique(
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Optional(CONF_MEDIA_PLAYER, default=data.get(CONF_MEDIA_PLAYER)): _entity("media_player"),
    ...
    async def async_step_lumiere(
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Optional(CONF_LUMIERE, default=data.get(CONF_LUMIERE)): _entity("light"),
    ...
    async def async_step_confort(
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Optional(CONF_RADIATEUR, default=data.get(CONF_RADIATEUR)): _entity("climate"),
                vol.Optional(CONF_CHAUFFE_EAU, default=data.get(CONF_CHAUFFE_EAU)): _entity("switch"),
                vol.Optional(CONF_CAFETIERE, default=data.get(CONF_CAFETIERE)): _entity("switch"),
                vol.Optional(CONF_CAFETIERE_MIN, default=data.get(CONF_CAFETIERE_MIN, DEFAULT_CAFETIERE_MIN)): _num(0, 30, 1, "min"),
                vol.Optional(CONF_VOLETS, default=data.get(CONF_VOLETS)): _entity("cover"),
    ...
    async def async_step_intelligence(
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                vol.Optional(CONF_PRESENCE, default=data.get(CONF_PRESENCE)): _entity("person"),
                vol.Optional(CONF_WORKDAY_SENSOR, default=data.get(CONF_WORKDAY_SENSOR)): _entity("binary_sensor"),
                vol.Optional(CONF_IGNORER_FERIES, default=data.get(CONF_IGNORER_FERIES, True)): bool,
                vol.Optional(CONF_VACANCES_SCOLAIRES_CALENDAR, default=data.get(CONF_VACANCES_SCOLAIRES_CALENDAR)): _entity("calendar"),
                vol.Optional(CONF_IGNORER_VACANCES_SCOLAIRE, default=data.get(CONF_IGNORER_VACANCES_SCOLAIRE, False)): bool,
                vol.Optional(CONF_WITHINGS_BED_1, default=data.get(CONF_WITHINGS_BED_1)): _entity("binary_sensor"),
                vol.Optional(CONF_WITHINGS_BED_2, default=data.get(CONF_WITHINGS_BED_2)): _entity("binary_sensor"),
                vol.Optional(CONF_MOUVEMENT_SDB, default=data.get(CONF_MOUVEMENT_SDB)): _entity("binary_sensor"),
                ...
                vol.Optional(CONF_MOUVEMENT_CUISINE, default=data.get(CONF_MOUVEMENT_CUISINE)): _entity("binary_sensor"),
    ...
    async def async_step_notification(
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Optional(CONF_TTS_ENTITY, default=data.get(CONF_TTS_ENTITY)): _entity("media_player"),
    ...
    async def async_step_ai(
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Optional(CONF_AI_TASK_ENTITY, default=data.get(CONF_AI_TASK_ENTITY)): _entity("ai_task"),
                ...
                vol.Optional(CONF_AI_CAMERA_VERIF, default=data.get(CONF_AI_CAMERA_VERIF)): _entity("camera"),
                vol.Optional(CONF_WEATHER_ENTITY, default=data.get(CONF_WEATHER_ENTITY)): _entity("weather"),
                vol.Optional(CONF_TRAJET_SENSOR, default=data.get(CONF_TRAJET_SENSOR)): _entity("sensor"),
                vol.Optional(CONF_BATTERIE_SENSOR, default=data.get(CONF_BATTERIE_SENSOR)): _entity("sensor"),
            }),
        )